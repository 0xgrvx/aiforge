...
export default function NetlifyConnection() {
      ...
      <div className="mt-6">
        <Collapsible open={isStatsOpen} onOpenChange={setIsStatsOpen}>
          <CollapsibleTrigger asChild>
            <div className="flex items-center justify-between p-4 rounded-lg bg-aiforge-elements-background dark:bg-aiforge-elements-background-depth-2 border border-aiforge-elements-borderColor dark:border-aiforge-elements-borderColor hover:border-aiforge-elements-borderColorActive/70 dark:hover:border-aiforge-elements-borderColorActive/70 transition-all duration-200">
              <div className="flex items-center gap-2">
                <div className="i-ph:chart-bar w-4 h-4 text-aiforge-elements-item-contentAccent dark:text-aiforge-elements-item-contentAccent" />
                <span className="text-sm font-medium text-aiforge-elements-textPrimary dark:text-aiforge-elements-textPrimary">
                  Netlify Stats
                </span>
              </div>
              <div
          ...
          <CollapsibleContent className="overflow-hidden">
            <div className="space-y-4 mt-4">
              <div className="flex flex-wrap items-center gap-4">
                <Badge
                  variant="outline"
                  className="flex items-center gap-1 text-aiforge-elements-textPrimary dark:text-aiforge-elements-textPrimary"
                >
                  <BuildingLibraryIcon className="h-4 w-4 text-aiforge-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-aiforge-elements-textPrimary dark:text-aiforge-elements-textPrimary"
                >
                  <RocketLaunchIcon className="h-4 w-4 text-aiforge-elements-item-contentAccent" />
                ...
                {lastUpdated && (
                  <Badge
                    ...
                    className="flex items-center gap-1 text-aiforge-elements-textPrimary dark:text-aiforge-elements-textPrimary"
                  >
                    <ClockIcon className="h-4 w-4 text-aiforge-elements-item-contentAccent" />
              ...
              {sites.length > 0 && (
                <div className="mt-4 space-y-4">
                  <div className="bg-aiforge-elements-background dark:bg-aiforge-elements-background-depth-1 border border-aiforge-elements-borderColor dark:border-aiforge-elements-borderColor rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-sm font-medium flex items-center gap-2 text-aiforge-elements-textPrimary dark:text-aiforge-elements-textPrimary">
                        <BuildingLibraryIcon className="h-4 w-4 text-aiforge-elements-item-contentAccent dark:text-aiforge-elements-item-contentAccent" />
                        Your Sites
                      </h4>
                      <Button
                        variant="outline"
                        ...
                        className="flex items-center gap-2 text-aiforge-elements-textPrimary dark:text-aiforge-elements-textPrimary hover:bg-aiforge-elements-item-backgroundActive/10"
                      >
                        <ArrowPathIcon
                          className={classNames(
                            'h-4 w-4 text-aiforge-elements-item-contentAccent dark:text-aiforge-elements-item-contentAccent',
                    ...
                    <div className="space-y-3">
                      {sites.map((site, index) => (
                        <div
                          key={site.id}
                          className={classNames(
                            'bg-aiforge-elements-background dark:bg-aiforge-elements-background-depth-1 border rounded-lg p-4 transition-all',
                            activeSiteIndex === index
                              ? 'border-aiforge-elements-item-contentAccent bg-aiforge-elements-item-backgroundActive/10'
                              : 'border-aiforge-elements-borderColor hover:border-aiforge-elements-borderColorActive/70',
                          )}
                          onClick={() => {
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <CloudIcon className="h-5 w-5 text-aiforge-elements-item-contentAccent dark:text-aiforge-elements-item-contentAccent" />
                              <span className="font-medium text-aiforge-elements-textPrimary dark:text-aiforge-elements-textPrimary">
                                {site.name}
                              </span>
                            </div>
                            <div className="flex items-center gap-2">
                              ...
                              >
                                ...
                                <span className="text-aiforge-elements-textPrimary dark:text-aiforge-elements-textPrimary">
                          ...
                          <div className="mt-3 flex items-center gap-2">
                            <a
                              ...
                              className="text-sm flex items-center gap-1 transition-colors text-aiforge-elements-link-text hover:text-aiforge-elements-link-textHover dark:text-white dark:hover:text-aiforge-elements-link-textHover"
                              onClick={(e) => e.stopPropagation()}
                            >
                              <CloudIcon className="h-3 w-3 text-aiforge-elements-item-contentAccent dark:text-aiforge-elements-item-contentAccent" />
                          ...
                          {activeSiteIndex === index && (
                            <>
                              <div className="mt-4 pt-3 border-t border-aiforge-elements-borderColor">
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    <Button
                                      ...
                                      className="flex items-center gap-1 text-aiforge-elements-textPrimary dark:text-aiforge-elements-textPrimary"
                                    >
                                      <action.icon className="h-4 w-4 text-aiforge-elements-item-contentAccent dark:text-aiforge-elements-item-contentAccent" />
                                      {action.name}
                                    </Button>
                                  ))}
                                </div>
                              ...
                              {site.published_deploy && (
                                <div className="mt-3 text-sm">
                                  <div className="flex items-center gap-1">
                                    <ClockIcon className="h-4 w-4 text-aiforge-elements-item-contentAccent dark:text-aiforge-elements-item-contentAccent" />
                                    <span className="text-aiforge-elements-textSecondary dark:text-aiforge-elements-textSecondary">
                                      Published {formatDistanceToNow(new Date(site.published_deploy.published_at))} ago
                                    </span>
                                  </div>
                                  {site.published_deploy.branch && (
                                    <div className="flex items-center gap-1 mt-1">
                                      <CodeBracketIcon className="h-4 w-4 text-aiforge-elements-item-contentAccent dark:text-aiforge-elements-item-contentAccent" />
                                      <span className="text-aiforge-elements-textSecondary dark:text-aiforge-elements-textSecondary">
                    ...
                    <div className="bg-aiforge-elements-background dark:bg-aiforge-elements-background-depth-1 border border-aiforge-elements-borderColor dark:border-aiforge-elements-borderColor rounded-lg p-4">
                      ...
                      <div className="space-y-2">
                        {deploys.map((deploy) => (
                          <div
                            key={deploy.id}
                            className="bg-aiforge-elements-background dark:bg-aiforge-elements-background-depth-1 border border-aiforge-elements-borderColor dark:border-aiforge-elements-borderColor rounded-lg p-3"
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <Badge
                              ...
                              <span className="text-xs text-aiforge-elements-textSecondary dark:text-aiforge-elements-textSecondary">
                                {formatDistanceToNow(new Date(deploy.created_at))} ago
                              </span>
                            </div>
                            {deploy.branch && (
                              <div className="mt-2 text-xs text-aiforge-elements-textSecondary dark:text-aiforge-elements-textSecondary flex items-center gap-1">
                                <CodeBracketIcon className="h-3 w-3 text-aiforge-elements-item-contentAccent dark:text-aiforge-elements-item-contentAccent" />
                                <span className="text-aiforge-elements-textSecondary dark:text-aiforge-elements-textSecondary">
                            ...
                            {deploy.deploy_url && (
                              <div className="mt-2 text-xs">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="flex items-center gap-1 transition-colors text-aiforge-elements-link-text hover:text-aiforge-elements-link-textHover dark:text-white dark:hover:text-aiforge-elements-link-textHover"
                                  onClick={(e) => e.stopPropagation()}
                                >
                                  <CloudIcon className="h-3 w-3 text-aiforge-elements-item-contentAccent dark:text-aiforge-elements-item-contentAccent" />
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-aiforge-elements-textPrimary dark:text-aiforge-elements-textPrimary"
                                >
                                  <LockClosedIcon className="h-4 w-4 text-aiforge-elements-item-contentAccent dark:text-aiforge-elements-item-contentAccent" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-aiforge-elements-textPrimary dark:text-aiforge-elements-textPrimary"
                                >
                                  <LockOpenIcon className="h-4 w-4 text-aiforge-elements-item-contentAccent dark:text-aiforge-elements-item-contentAccent" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                      ...
                      <div className="space-y-2">
                        {builds.map((build) => (
                          ...
                          >
                            ...
                            {build.error && (
                              <div className="mt-2 text-xs text-aiforge-elements-textDestructive dark:text-aiforge-elements-textDestructive flex items-center gap-1">
                                <XCircleIcon className="h-3 w-3 text-aiforge-elements-textDestructive dark:text-aiforge-elements-textDestructive" />
                                Error: {build.error}
                              </div>
                            )}
                          </div>
  ...
  return (
    <div className="space-y-6 bg-aiforge-elements-background dark:bg-aiforge-elements-background border border-aiforge-elements-borderColor dark:border-aiforge-elements-borderColor rounded-lg">
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium text-aiforge-elements-textPrimary">Netlify Connection</h2>
          </div>
        </div>

        {!connection.user ? (
          <div className="mt-4">
            <label className="block text-sm text-aiforge-elements-textSecondary dark:text-aiforge-elements-textSecondary mb-2">
              API Token
            </label>
            <input
              type="password"
              ...
              className={classNames(
                ...
                'text-aiforge-elements-textPrimary placeholder-aiforge-elements-textTertiary',
                'focus:outline-none focus:ring-1 focus:ring-aiforge-elements-borderColorActive',
                'disabled:opacity-50',
              )}
            />
            <div className="mt-2 text-sm text-aiforge-elements-textSecondary">
              <a
                href="https://app.netlify.com/user/applications#personal-access-tokens"
                target="_blank"
                rel="noopener noreferrer"
                className="text-aiforge-elements-borderColorActive hover:underline inline-flex items-center gap-1"
              >
                Get your token
          ...
          <div className="flex flex-col w-full gap-4 mt-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-aiforge-elements-textSecondary flex items-center gap-1">
