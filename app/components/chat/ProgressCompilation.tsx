      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-aiforge-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-aiforge-elements-item-backgroundAccent hover:bg-aiforge-elements-artifacts-backgroundHover"
