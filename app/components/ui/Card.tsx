  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-aiforge-elements-borderColor bg-aiforge-elements-background-depth-1 text-aiforge-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-aiforge-elements-textSecondary', className)} {...props} />;
  },
);
