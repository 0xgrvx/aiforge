      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-aiforge-elements-textPrimary dark:text-aiforge-elements-textPrimary-dark'
              : 'text-aiforge-elements-textSecondary dark:text-aiforge-elements-textSecondary-dark hover:text-aiforge-elements-textPrimary dark:hover:text-aiforge-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-aiforge-elements-textTertiary dark:text-aiforge-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
