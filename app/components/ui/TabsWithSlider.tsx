        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-aiforge-elements-background-depth-2 dark:bg-aiforge-elements-background-depth-3 text-aiforge-elements-textPrimary dark:text-aiforge-elements-textPrimary-dark hover:bg-aiforge-elements-background-depth-3 dark:hover:bg-aiforge-elements-background-depth-4 border border-aiforge-elements-borderColor dark:border-aiforge-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
