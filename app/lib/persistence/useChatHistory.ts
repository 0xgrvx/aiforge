            ...
            if (startingIdx > 0) {
              ...
              filteredMessages = [
                ...
                },
                {
                  ...
                  content: `Aiforge Restored your chat from a snapshot. You can revert this message to load the full chat history.
                  <aiforgeArtifact id="restored-project-setup" title="Restored Project & Setup" type="bundled">
                  ${Object.entries(snapshot?.files || {})
                    .map(([key, value]) => {
                      if (value?.type === 'file') {
                        return `
                      <aiforgeAction type="file" filePath="${key}">
${value.content}
                      </aiforgeAction>
                      `;
                      } else {
