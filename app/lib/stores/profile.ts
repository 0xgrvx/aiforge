...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('aiforge_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('aiforge_profile', JSON.stringify(profileStore.get()));
  }
};
