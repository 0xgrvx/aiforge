...
export class WorkbenchStore {
  ...
  get aiforgeTerminal() {
    return this.#terminalStore.aiforgeTerminal;
  }
  get alert() {
  ...
  attachAiforgeTerminal(terminal: ITerminal) {
    this.#terminalStore.attachAiforgeTerminal(terminal);
  }
