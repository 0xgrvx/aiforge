...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out aiforge artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <aiforge', 'Foo bar '],
      ['Foo bar <aiforgea', 'Foo bar <aiforgea'],
      ['Foo bar <aiforgeA', 'Foo bar '],
      ['Foo bar <aiforgeArtifacs></aiforgeArtifact>', 'Foo bar <aiforgeArtifacs></aiforgeArtifact>'],
      ['Before <oltArtfiact>foo</aiforgeArtifact> After', 'Before <oltArtfiact>foo</aiforgeArtifact> After'],
      ['Before <aiforgeArtifactt>foo</aiforgeArtifact> After', 'Before <aiforgeArtifactt>foo</aiforgeArtifact> After'],
    ])('should correctly parse chunks and strip out aiforge artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <aiforgeArtifact title="Some title" id="artifact_1">foo bar</aiforgeArtifact> Some more text',
        {
      ...
      [
        [
          ...
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</aiforgeArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</aiforgeArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</aiforgeArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          'o',
          '<',
          '/aiforgeArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <aiforgeArtifact title="Some title" id="artifact_1">foo</aiforgeArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <aiforgeArtifact title="Some title" id="artifact_1"><aiforgeAction type="shell">npm install</aiforgeAction></aiforgeArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <aiforgeArtifact title="Some title" id="artifact_1"><aiforgeAction type="shell">npm install</aiforgeAction><aiforgeAction type="file" filePath="index.js">some content</aiforgeAction></aiforgeArtifact> After',
        {
          output: 'Before  After',
