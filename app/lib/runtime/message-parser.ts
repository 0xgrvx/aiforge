...
const ARTIFACT_TAG_OPEN = '<aiforgeArtifact';
const ARTIFACT_TAG_CLOSE = '</aiforgeArtifact>';
const ARTIFACT_ACTION_TAG_OPEN = '<aiforgeAction';
const ARTIFACT_ACTION_TAG_CLOSE = '</aiforgeAction>';
