...
<artifact_info>
  ...
  - Use \`<aiforgeArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<aiforgeAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<aiforgeArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<aiforgeAction>\` tags with appropriate \`type\` attribute:
